...
def filter_results(boxlists, nms_thresh=0.8, max_proposals=0, score_field="scores"):
    """
...
def cat_boxlist(bboxes):
    ...
    assert all(set(bbox.fields()) == fields for bbox in bboxes), ' {} {}'.format(fields, bboxes[1].fields())
