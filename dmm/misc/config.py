...
# Data folder
__C.PATH.DATA = osp.abspath('%s/datasets/DAVIS/'%__C.PATH.ROOT)
...
__C.FILES.DB_INFO = osp.abspath(osp.join(__C.PATH.ROOT,"dmm/dataloader/db_info.yaml"))
...
# Load all sequences
__C.SEQUENCES = dict() #dict([(sequence.name,sequence) for sequence in db_read_sequences()])

__C.PATH.PALETTE = 'dmm/dataloader/palette.txt'
